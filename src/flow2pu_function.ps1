    ...
    Format:
        ...
        Indented item treated as note block:
            ...
            2. Second step
                ...
                + Indented item = note
                + Indented item = note
            3. Hyphen is left note, otherwise right note
...
.LINK
    pu2java, dot2gviz, pert, pert2dot, pert2gantt2pu, mind2dot, flow2pu, gantt2pu, logi2dot, logi2dot2, logi2dot3, logi2pu, logi2pu2, flow2pu
